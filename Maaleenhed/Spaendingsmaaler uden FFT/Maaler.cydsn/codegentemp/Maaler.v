...
module ADC_DelSig_v3_20_0 (
	...
	cy_clock_v1_0
		#(.id("9cd307cf-7f26-42e0-a1c1-46275507b70a/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("9cd307cf-7f26-42e0-a1c1-46275507b70a/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("390625000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__ProbeU1_net;
	wire [0:0] tmpFB_0__ProbeU1_net;
	wire [0:0] tmpIO_0__ProbeU1_net;
	wire [0:0] tmpINTERRUPT_0__ProbeU1_net;
	electrical [0:0] tmpSIOVREF__ProbeU1_net;
	...
	assign tmpOE__ProbeU1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ProbeU2_net;
	wire [0:0] tmpFB_0__ProbeU2_net;
	wire [0:0] tmpIO_0__ProbeU2_net;
	wire [0:0] tmpINTERRUPT_0__ProbeU2_net;
	electrical [0:0] tmpSIOVREF__ProbeU2_net;

	cy_psoc3_pins_v1_10
		#(.id("cdf97f31-de08-4878-876d-af98e73797d5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ProbeU2
		 (.oe(tmpOE__ProbeU2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ProbeU2_net[0:0]}),
		  .analog({Net_23}),
		  .io({tmpIO_0__ProbeU2_net[0:0]}),
		  .siovref(tmpSIOVREF__ProbeU2_net),
		  .interrupt({tmpINTERRUPT_0__ProbeU2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ProbeU2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ProbeI1_net;
	wire [0:0] tmpFB_0__ProbeI1_net;
	wire [0:0] tmpIO_0__ProbeI1_net;
	wire [0:0] tmpINTERRUPT_0__ProbeI1_net;
	electrical [0:0] tmpSIOVREF__ProbeI1_net;

	cy_psoc3_pins_v1_10
		#(.id("53aa6ed3-02d1-4dab-9959-cf1a8888a3a8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__ProbeI1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ProbeI2_net;
	wire [0:0] tmpFB_0__ProbeI2_net;
	wire [0:0] tmpIO_0__ProbeI2_net;
	wire [0:0] tmpINTERRUPT_0__ProbeI2_net;
	electrical [0:0] tmpSIOVREF__ProbeI2_net;

	cy_psoc3_pins_v1_10
		#(.id("1d756dad-1ba0-4f18-9d96-1b93c0eb8426"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ProbeI2
		 (.oe(tmpOE__ProbeI2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ProbeI2_net[0:0]}),
		  .analog({Net_26}),
		  .io({tmpIO_0__ProbeI2_net[0:0]}),
		  .siovref(tmpSIOVREF__ProbeI2_net),
		  .interrupt({tmpINTERRUPT_0__ProbeI2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ProbeI2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
