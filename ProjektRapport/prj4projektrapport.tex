...
\chapter{Arkitektur}
\include{sektioner/Arkitektur/Indledning}
\include{sektioner/Arkitektur/BDD}
\include{sektioner/Arkitektur/IBD}
\include{sektioner/Arkitektur/Allokering}
\chapter{Design af distributionslinje, belastning og trinskifter}
\chapter{Design af Måleenhed}
\chapter{Design af Styringsenhed}
\include{sektioner/Styringsenhed/Indledning}
\include{sektioner/Styringsenhed/Foranalyse}
\include{sektioner/Styringsenhed/Kontrolmodul}
\include{sektioner/Styringsenhed/Brugergraenseflade}
\include{sektioner/Styringsenhed/Kommunikationsmodul}
\include{sektioner/Styringsenhed/Delkonklusion}
